...
#run_training performs the CNN in tensorflow
def run_training2():
    ...
    save_dir = "D://MMAI//MMAI894//Project//save_workspace//" #kevin's desktop
    ...
    #call model_fn to pass image and label into logits, loss, optimazer and evaluation
